...
from public.endpoints.api import EtsyPublicAPI
from etsy_trackers.core.shop_scraper import ShopScraper
import json
...
def estimate_listing_sales(listing_id, public_api=None):
    ...
    cache_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "public", "data", "raw")
