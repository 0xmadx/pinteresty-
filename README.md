...
```
One of **52 offline suites** — 1,413 assertions, no network required.
...
| `mcp_server/` | the agent-facing surface — 21 tools reaching 46 capabilities, wired by `.mcp.json` |
...
scaffold · 21 MCP tools — the interface (D-52), Pinterest included (D-55/D-56).
