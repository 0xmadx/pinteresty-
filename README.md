...
```
One of **51 offline suites** — 1,393 assertions, no network required.
...
| `mcp_server/` | the agent-facing surface — 20 tools reaching 44 capabilities, wired by `.mcp.json` |
...
scaffold · 20 MCP tools — the interface (D-52), Pinterest included (D-55/D-56).
