...
```
One of **52 offline suites** — 1,417 assertions, no network required.
...
| `mcp_server/` | the agent-facing surface — 25 tools reaching 70 capabilities, wired by `.mcp.json` |
...
scaffold · 25 MCP tools — the interface (D-52), Pinterest included (D-55/D-56).
