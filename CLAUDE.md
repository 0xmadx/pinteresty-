...
# 52 OFFLINE suites, 1,416 assertions, no network required.
...
| `docs/MCP.md` | **tutorial**: wiring the MCP server (24 tools; six group 44 operations) into Claude Code/Desktop/Antigravity, the tool table, troubleshooting, and where DeepSeek is allowed to touch the system |
...
request cache · run log · guards. 52 offline suites, 1,416 assertions (+5 live
...
**1,416 assertions** across 52 offline suites, plus 5 live pinterest suites.
