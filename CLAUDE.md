...
# 51 OFFLINE suites, 1,389 assertions, no network required.
...
| `docs/MCP.md` | **tutorial**: wiring the MCP server (19 tools, one grouping 15 operations) into Claude Code/Desktop/Antigravity, the tool table, troubleshooting, and where DeepSeek is allowed to touch the system |
...
request cache · run log · guards. 51 offline suites, 1,389 assertions (+5 live
...
**1,389 assertions** across 51 offline suites, plus 5 live pinterest suites.
