...
# 61 offline suites, ~1,515 assertions, no network required
```
...
request cache · run log · guards. 61 test suites, ~1,515 assertions, all offline.
...
**~1,515 assertions** across 61 suites.
